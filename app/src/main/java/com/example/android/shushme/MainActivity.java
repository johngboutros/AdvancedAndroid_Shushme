...
public class MainActivity extends AppCompatActivity implements
    ...
    private static final int PLACE_PICKER_RESULT_CODE = 234;
    ...
    public void onAddPlaceButtonClicked(View view) {
        ...
        if (intent != null) {
            startActivityForResult(intent, PLACE_PICKER_RESULT_CODE);
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PLACE_PICKER_RESULT_CODE && resultCode == RESULT_OK) {
            Place place = PlacePicker.getPlace(this, data);

            if (place == null) {
                Log.i(TAG, "PlacePicker result: No place selected!");
                return;
            }
