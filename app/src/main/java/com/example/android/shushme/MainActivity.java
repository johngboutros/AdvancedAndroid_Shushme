...
import com.example.android.shushme.geofence.Geofencing;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Switch geofencesSwitch = findViewById(R.id.enable_switch);

        geofencingEnabled = getPreferences(MODE_PRIVATE)
                .getBoolean(getString(R.string.setting_enabled), false);

        geofencesSwitch.setChecked(geofencingEnabled);
        ...
        geofencesSwitch.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            @Override
    ...
    public void refreshPlacesData() {
        ...
        placeResult.setResultCallback(new ResultCallback<PlaceBuffer>() {
            ...
            public void onResult(@NonNull PlaceBuffer places) {
                ...
                geofencing.updateGeofences(places);
                if (geofencingEnabled) geofencing.registerAllGeofences();
            }
        });
    }
